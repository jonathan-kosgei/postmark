...
class BounceSearchResponse(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, total_count=None, bounces=None):
        """
        BounceSearchResponse - a model defined in Swagger
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, BounceSearchResponse):
            return False
