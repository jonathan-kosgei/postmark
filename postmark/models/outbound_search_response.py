...
class OutboundSearchResponse(object):
    """
    ...
    def __init__(self, total_count=None, messages=None):
        """
        OutboundSearchResponse - a model defined in Swagger
    ...
    def messages(self, messages):
        ...
        :type: list[OutboundMessageDetail]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, OutboundSearchResponse):
            return False
